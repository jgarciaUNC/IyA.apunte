...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{Imagenes/tipos-navegacion.eps}
...
% 	\centering
%   \includegraphics[keepaspectratio,width=0.9\textwidth]{./Imagenes/dead-reckoning.png}
...
Con la evoluci\'on y desarrollo de las aeronaves, as\'i como el aumento de la autonom\'ia de vuelo, se hizo patente la necesidad de nuevos sistemas de posicionamiento que permitieran atravesar  zonas en las cuales las radio ayudas
 ...
 % \begin{figure}[!h]
 %   \centering
 %   \subfigure[Astrolabio]{\includegraphics[height=6cm]{Imagenes/astrolabio.jpg}}
 %   \subfigure[Sextante]{\includegraphics[height=6cm]{Imagenes/sextante.jpg}   
...
\subfigure[Precision Approach Path Indicator - PAPI \cite{wikipedia_esp} ]{\includegraphics[keepaspectratio,height=7cm]{./Imagenes/papi.png}
  \label{fig:papi}}
\subfigure[Vista a\'erea de un VOR \cite{wikipedia_esp}]{\includegraphics[keepaspectratio,height=7cm]{./Imagenes/DVOR-aerea.png}
...
\begin{figure}[!h]
  \centering
  \subfigure[Sat\'elite GPS generaci\'on IIF \cite{wikipedia_esp}]{\includegraphics[keepaspectratio,height=5cm]{./Imagenes/GPS-Satellite-IIF.png}
  \label{fig:satelite-GPS}}
  \subfigure[Sat\'elite GLONASS]{\includegraphics[keepaspectratio,height=5cm]{./Imagenes/glonass.jpg}
  \label{fig:satelite-GPS}}
  \subfigure[Sat\'elite GALILEO]{\includegraphics[keepaspectratio,height=5cm]{./Imagenes/gps-galileo.jpg}
  \label{fig:satelite-GPS}}
...
\begin{figure}[!h]
  \centering
 \subfigure[M\'etodo $\theta$]{\includegraphics[width=0.45\textwidth]{./Imagenes/theta-fix.png}  \label{fig:theta-fix}}
\subfigure[M\'etodo $\theta$ con marco de referencia ]{\includegraphics[width=0.45\textwidth]{./Imagenes/theta-lop1.png}  \label{fig:theta-lop1}}
...
\begin{figure}[!h]
  ...
  \subfigure[M\'etodo $\theta-\rho$]{
     \includegraphics[height=6cm]{./Imagenes/theta-rho-fix.png}  
     \label{fig:theta-rho-fix}
   }
  \subfigure[M\'etodo $\rho$-$\rho$]{
  \includegraphics[height=6cm]{./Imagenes/rho-rho-fix.png} 
...
\subfigure[Forma de la tierra, dimensiones exageradas]{
	\includegraphics[height=6cm]{Imagenes/forma-tierra.jpg}
	\label{fig:forma.tierra}}
  \subfigure[Amanecer de la Tierra, misi\'on \mbox{Apolo 8} (1968)]{
\includegraphics[height=6cm]{Imagenes/amanecer-tierra.jpg}
...
\includegraphics[height=6.5cm]{Imagenes/dimensiones-tierra.png}
	  \label{fig:dimensiones.tierra}}
  \subfigure[
Rotaci\'on
]{
\includegraphics[height=6.5cm]{Imagenes/RotacionTerrestre.png}
 \label{fig:rotacion.tierra}}
  \subfigure[
Precesi\'on
]{
\includegraphics[height=6.5cm]{Imagenes/Precesion.png}
 \label{fig:precesion.tierra}}
  \subfigure[
Nutaci\'on
]{
\includegraphics[height=6.5cm]{Imagenes/nutacion.png}
 \label{fig:nutacion.tierra}}
  \subfigure[
Los movimientos \mbox{principales}
]{
\includegraphics[height=6.5cm]{Imagenes/rotacion-precession-nutation.png}
...
\begin{figure}[!h]
  \subfigure[Loxodr\'omica]{\includegraphics[height=5.8cm]{./Imagenes/loxodromica.png} \label{fig:loxodromica}}
  \subfigure[Ortodr\'omica]{\includegraphics[height=5.8cm]{./Imagenes/ortodroma.png} \label{fig:ortodromica}}
  \subfigure[Comparaci\'on de ambas l\'ineas]{\includegraphics[height=5.8cm]{./Imagenes/comp-loxo-orto.png} \label{fig:ortodromica.loxodromica.comparacion}}
...
\begin{figure}[!h]
  \centering
  \subfigure[Rosa de comp\'as]{\includegraphics[height=6.7cm]{./Imagenes/rosa.png}  \label{fig:rosa.de.compas}}
  \subfigure[Trayectoria, ruta]{\includegraphics[height=6.7cm]{./Imagenes/trayectoria-ruta.png}  \label{fig:trayectoria}} 
...
\begin{figure}[!h]
  \centering
  \subfigure[Curso]{\includegraphics[keepaspectratio,height=10cm]{./Imagenes/curso-derrota-rumbo-marcacion.png}  \label{fig:curso}}
...
\begin{figure}[!h]
  \centering
  \subfigure[Reloj de sol]{\includegraphics[height=6.5cm]{./Imagenes/reloj-de-sol.jpg} \label{fig:reloj.de.sol}}
  \subfigure[Ecuaci\'on del tiempo, a\~no 2012]{\includegraphics[height=6.5cm]{./Imagenes/2012-ecuacion-tiempo.jpg} \label{fig:2012.ecuacion.del.tiempo}}

  \subfigure[Meridiano de Greenwich]{\includegraphics[height=6.5cm]{./Imagenes/Greenwich-Meridian-Line.jpg} \label{fig:meridiano.greenwich}}
  \subfigure[Primer reloj at\'omico (1948)]{\includegraphics[height=6.5cm]{./Imagenes/TAI.jpg} \label{fig:primer.reloj.atomico}}
...
\begin{figure}[!htb]
    \centering
\includegraphics[keepaspectratio,width=0.6\textwidth]{./Imagenes/declinacion-desviacion.png}
...
\begin{figure}[!h]
  ...
  \includegraphics[height=7cm]{./Imagenes/merEqTh.png}
  \label{fig:proyeccion.mercator.groenlandia.africa}
  }
  \subfigure[Proyeccion Mollweide]{
  \includegraphics[height=7cm]{./Imagenes/mollEqTh.png}
...
\begin{figure}[!h]
  ...
  \subfigure[Proyecci\'on Mercator]{
	\includegraphics[height=6cm]{./Imagenes/gr-mr-s70-n80-s-40.png}
	}
  \subfigure[Proyecci\'on polar azimutal equidistante]{
	\includegraphics[height=6cm]{./Imagenes/gr-aze-s70.png}
	}
  \subfigure[Proyecci\'on Lagrange]{
	\includegraphics[height=6cm]{./Imagenes/lg-s70h.png}
	}
...
\begin{landscape}
  \input{tex/cartas.aeronauticas.OACI.landscape.tex}
\end{landscape}
...
\begin{figure}[!h]
  \centering
  \includegraphics[height=8cm]{Imagenes/2000px-Lambert_conformal_conic.png}
%  \includegraphics[height=8cm]{Imagenes/proy_conica_lambert.jpg}
...
%   \includegraphics[width=0.45\textwidth]{Imagenes/proy-conicas-tang-sec.png}
