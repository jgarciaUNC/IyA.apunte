...
Un concepto interesante que relaciona las l\'ineas ortodr\'omicas y las millas n\'auticas es que sobre las mismas se puede calcular la distancia entre dos puntos. Por ejemplo, dados los puntos A y B sobre una de estas curvas, ver Figura  \ref{fig:Distancia.entre.dos.puntos.esfera.terrestre.tikz}.
El ángulo entre los radio vectores que parten del centro de la esfera y terminan en cada uno de estos puntos es 30º 25'. Convirtiendo este \'angulo a minutos se obtiene 1825', como 1' = 1 NM, sobre la esfera que representa al planeta Tierra la distancia entre los puntos A y B es de 1825 NM.

\begin{figure}[!h] \centering
	\includegraphics[height=5.8cm]{06.radionavegacion/Imagenes/06.00.navegacion/06_milla_nautica.png} 
        \parbox{0.8\textwidth}{c}{
	\caption{Distancia entre dos puntos sobre la Tierra. \\
	{\footnotesize Adaptado de \protect\cite{Tooley_Aircraft_communications_and_navigation_systems}}}
	}
...
UTC tiene la misma frecuencia del TAI pero cada cierto tiempo se le añaden (o sustraen) segundos extras (llamados ``leap seconds'') para mantenerlo sincronizado dentro de $\pm 0.9$ s de UT1. De esta manera, se obtiene la exactitud del tiempo atómico sin divorciarse completamente del fenómeno de la rotación terrestre.
...
La época de inicio de los relojes atómicos del sistema Loran-C fue las 0h del 01 de enero de 1958.
...
\begin{figure}[!htb]
  ...
  \caption{Movimiento de los polos magn\'eticos, {\scriptsize Fuente \url{http://wdc.kugi.kyoto-u.ac.jp/poles/polesexp.html\#Fig1}}}
